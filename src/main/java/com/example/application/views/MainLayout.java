...
public class MainLayout extends AppLayout {
    ...
    private VerticalLayout createNavigation() {
        ...
        SideNav administration = new SideNav();
        ...
        primes.addItem(new SideNavItem("Bulteins de paie" , BultainDePaieView.class , LineAwesomeIcon.LIST_ALT.create()));
        ...
        administration.setCollapsible(true);
        ...
        VerticalLayout navWrapper = new VerticalLayout(nav , employees , conge , primes , deplacements , absences , administration);
